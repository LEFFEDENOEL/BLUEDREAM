...
namespace BLLForadev
{
    ...
    public static class BLLMain
    {
        ...
        /// <returns>Méthode de la classe DALMain</returns>
        ...
        /// <summary>
        /// Méthode d'appel de la méthode qui permet la création d'un utilisateur depuis la classe DALMain
        /// </summary>
        ...
        /// <returns>Renvoit l'identifiant du sujet en INT ou NULL sur appel méthode dans la classe DALMain</returns>
        ...
        /// <returns>Renvoit l'identifiant de la réponse en INT ou NULL sur appel méthode dans la classe DALMain</returns>
        ...
        /// </summary>
        /// <param name="idSujet"></param>
        /// <returns>La méthode présente dans la classe DALMain</returns>
        ...
        /// <returns>Renvoit la méthode présente dans la classe DALMain</returns>
